...
一款为《洛克王国：世界》玩家打造的轻量数据查询工具，基于游戏原始配置数据提取，支持精灵图鉴、技能查询、属性克制计算、性格查询、蛋组查询、神秘蛋推测等功能。
...
| 模块 | 说明 |
|------|------|
| **精灵图鉴** | 浏览全部图鉴精灵，支持按属性筛选、按图鉴编号排序，查看种族值、进化链（含地区形态与 BOSS 形态）、特性、技能表 |
...
| **神秘蛋推测** | 输入精灵蛋的身高与体重，推测可能的精灵，并展示蛋的身高体重范围与孵化时间 |
